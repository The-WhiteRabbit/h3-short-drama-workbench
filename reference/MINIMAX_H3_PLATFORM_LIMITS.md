...
- H3-Base-FL2VA accepts zero, one, or two images for text-to-video, first-frame, last-frame, or first-and-last-frame generation. The H3 Short Drama Workbench may retain a narrower production intake when its workflow requires submitted references; do not misstate that workflow choice as a platform limitation.
